		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manutenção de cartão Kanban",
									"targetURL": "#zz1editcartoes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zz1editcartoes-display": {
								"semanticObject": "zz1editcartoes",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zz1editcartoes",
									"url": sap.ui.require.toUrl("zz1editcartoes")
								}
							}
						}
					}
